      ...
      <div className="footer-content relative z-10 p-10">
          ...
          <nav className="flex flex-col space-x-4">
            ...
            <form className="flex space-x-2">
              <input
                ...
                className="p-2 border rounded-full flex text-center"
              />
              <button
                type="submit"
                className="bg-[#1F5434] text-white px-4 py-2 rounded-full"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-6 flex justify-between items-center">
          <form className="flex space-x-10">
            ...
            <Link href="#">
              <span className="text-black hover:text-gray-700">About Us</span>
            </Link>
            <Link href="#">
              <span className="text-black hover:text-gray-700">Pricing</span>
            </Link>
            <Link href="#">
              <span className="text-black hover:text-gray-700">Contact Us</span>
            </Link>
          </form>
